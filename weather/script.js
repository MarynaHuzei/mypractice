...
function handlerForecast(evt) {
  ...
  serviceWeather(city.value, days.value)
    ...
    .catch((err) => {
      elements.list.innerHTML = `<li class="weather-card"><img src="https://img.freepik.com/premium-vector/internet-connection-problem-concept-illustration-404-found-error-page-isolated-white-background-gray-cloud-with-rain-lightning-isolated-vector-illustrations_450656-203.jpg?w=1800" alt="weather" width = "500" /></li>`;
      console.log(err);
    });
}
...
function serviceWeather(city = "", days = "0") {
  ...
  const API_KEY = "84e3584cb3a54284b4e105706231511";
